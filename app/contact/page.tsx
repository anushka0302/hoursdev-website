  ...
  return (
    <main className="relative min-h-screen bg-[#050505] text-white selection:bg-purple-500/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Adjusted blurs and positions for mobile */}
        ...
        {/* Adjusted circle sizes for mobile */}
        <motion.div 
            animate={{ rotate: 360 }} 
      ...
      {/* LAYER 1: CONTENT */}
      {/* Changed: pt-24 (mobile) vs pt-32 (desktop), gap-12 (mobile) vs gap-20 (desktop) */}
      <div className="relative z-10 pt-24 md:pt-32 pb-12 md:pb-20 px-4 md:px-12 max-w-[1400px] mx-auto min-h-screen flex flex-col md:flex-row gap-12 md:gap-20">
        ...
        <motion.div className="md:w-1/2" initial="hidden" animate="visible" variants={staggerContainer}>
          {/* Changed: text-5xl (mobile) vs text-8xl (desktop) */}
          ...
          {/* TERMINAL DECORATION (Hidden on mobile to save space) */}
        ...
        <motion.div className="md:w-1/2" initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }}>
          {/* Changed: p-6 (mobile) vs p-12 (desktop) */}
          <div className="bg-white/5 backdrop-blur-xl p-6 md:p-12 rounded-3xl border border-white/10 hover:border-white/20 transition-all duration-500 shadow-2xl relative overflow-hidden group">
            ...
            {/* Changed: gap-6 (mobile) vs gap-8 (desktop) */}
            <form action={handleSubmit} className="flex flex-col gap-6 md:gap-8 relative z-10">
              ...
              <div className="flex flex-col gap-2 group/input">
                ...
                <input type="text" name="name" className="bg-transparent border-b border-white/20 focus:border-blue-400 outline-none py-2 md:py-3 text-base md:text-lg transition-colors placeholder:text-gray-700" placeholder="Jane Doe" required />
              </div>
              ...
              <div className="flex flex-col gap-2 group/input">
                ...
                <input type="email" name="email" className="bg-transparent border-b border-white/20 focus:border-blue-400 outline-none py-2 md:py-3 text-base md:text-lg transition-colors placeholder:text-gray-700" placeholder="jane@company.com" required />
              </div>
              ...
              <div className="flex flex-col gap-2 group/input">
                ...
                <input type="tel" name="mobile" className="bg-transparent border-b border-white/20 focus:border-blue-400 outline-none py-2 md:py-3 text-base md:text-lg transition-colors placeholder:text-gray-700" placeholder="+91 98765 43210" />
              </div>
              ...
              <div className="flex flex-col gap-2 group/input">
                ...
                <select name="service" className="bg-transparent border-b border-white/20 focus:border-blue-400 outline-none py-2 md:py-3 text-base md:text-lg transition-colors text-white [&>option]:text-black cursor-pointer appearance-none">
              ...
              <div className="flex flex-col gap-2 group/input">
                ...
                <textarea name="message" rows={4} className="bg-transparent border-b border-white/20 focus:border-blue-400 outline-none py-2 md:py-3 text-base md:text-lg transition-colors resize-none placeholder:text-gray-700" placeholder="Tell us about your project..." required></textarea>
              </div>

              <button type="submit" className="mt-2 md:mt-4 bg-white text-black py-3 md:py-4 rounded-full font-bold uppercase tracking-widest hover:bg-gray-200 hover:scale-[1.02] transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] text-sm md:text-base">
                Send Message
              </button>
